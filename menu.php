						...
						<div class="navbar-header">
							...
							<a class="navbar-brand" href="index.php" style="padding: 10px 0 0;">
								<img src="<?php echo $_SESSION['collegelogo']; ?>" 
								style="height: 95px;width: 95px; margin-left: 10px; margin-bottom: 10px; border-radius: 35px;
						...
						<div class="collapse navbar-collapse" id="myNavbar" style="margin-right: 100px;">
							<ul class="nav navbar-nav link-effect" style="margin-right: 0;">
