...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 14, 2022 at 10:02 PM
...
(985, 99, 38, 12, 25.00, 1.00, 0.00, 0.00, 'test me', 'Active'),
(986, 99, 38, 16, 20.00, 2.00, 0.00, 0.00, 'test me', 'Active'),
(987, 99, 38, 17, 25.00, 3.00, 0.00, 0.00, 'test me', 'Active'),
(988, 99, 39, 12, 25.00, 4.00, 0.00, 0.00, 'test me', 'Active'),
(989, 99, 39, 16, 20.00, 5.00, 0.00, 0.00, 'test me', 'Active'),
(990, 99, 39, 17, 25.00, 6.00, 0.00, 0.00, 'test me', 'Active'),
(991, 99, 40, 12, 25.00, 7.00, 0.00, 0.00, 'test me', 'Active'),
(992, 99, 40, 16, 20.00, 8.00, 0.00, 0.00, 'test me', 'Active'),
(993, 99, 40, 17, 25.00, 9.00, 0.00, 0.00, 'test me', 'Active'),
(994, 99, 41, 12, 25.00, 10.00, 0.00, 0.00, 'test me', 'Active'),
(995, 99, 41, 16, 20.00, 11.00, 0.00, 0.00, 'test me', 'Active'),
(996, 99, 41, 17, 25.00, 12.00, 0.00, 0.00, 'test me', 'Active'),
(997, 99, 42, 12, 25.00, 15.00, 0.00, 0.00, 'test me', 'Active'),
(998, 99, 42, 16, 20.00, 15.00, 0.00, 0.00, 'test me', 'Active'),
(999, 99, 42, 17, 25.00, 16.00, 0.00, 0.00, 'test me', 'Active'),
(1000, 99, 43, 12, 25.00, 19.00, 0.00, 0.00, 'test me', 'Active'),
(1001, 99, 43, 16, 20.00, 19.00, 0.00, 0.00, 'test me', 'Active'),
(1002, 99, 43, 17, 25.00, 19.00, 0.00, 0.00, 'test me', 'Active'),
(1003, 99, 45, 12, 25.00, 14.00, 0.00, 0.00, 'test me', 'Active'),
(1004, 99, 45, 16, 20.00, 15.00, 0.00, 0.00, 'test me', 'Active'),
(1005, 99, 45, 17, 25.00, 16.00, 0.00, 0.00, 'test me', 'Active'),
(1006, 102, 38, 12, 20.00, 10.00, 100.00, 32.00, 'test me', 'Active'),
(1007, 102, 38, 16, 25.00, 10.00, 100.00, 32.00, 'test me', 'Active'),
(1008, 102, 38, 17, 20.00, 5.00, 100.00, 30.00, 'test me', 'Active'),
(1009, 102, 39, 12, 20.00, 15.00, 100.00, 78.00, 'test me', 'Active'),
(1010, 102, 39, 16, 25.00, 16.00, 100.00, 56.00, 'test me', 'Active'),
(1011, 102, 39, 17, 20.00, 18.00, 100.00, 85.00, 'test me', 'Active'),
(1012, 102, 40, 12, 20.00, 18.00, 100.00, 85.00, 'test me', 'Active'),
(1013, 102, 40, 16, 25.00, 15.00, 100.00, 45.00, 'test me', 'Active'),
(1014, 102, 40, 17, 20.00, 12.00, 100.00, 56.00, 'test me', 'Active'),
(1015, 102, 41, 12, 20.00, 5.00, 100.00, 6.00, 'test me', 'Active'),
(1016, 102, 41, 16, 25.00, 7.00, 100.00, 8.00, 'test me', 'Active'),
(1017, 102, 41, 17, 20.00, 9.00, 100.00, 10.00, 'test me', 'Active'),
(1018, 102, 42, 12, 20.00, 19.00, 100.00, 98.00, 'test me', 'Active'),
(1019, 102, 42, 16, 25.00, 19.00, 100.00, 97.00, 'test me', 'Active'),
(1020, 102, 42, 17, 20.00, 19.00, 100.00, 96.00, 'test me', 'Active'),
(1021, 102, 43, 12, 20.00, 18.00, 100.00, 95.00, 'test me', 'Active'),
(1022, 102, 43, 16, 25.00, 13.00, 100.00, 85.00, 'test me', 'Active'),
(1023, 102, 43, 17, 20.00, 15.00, 100.00, 92.00, 'test me', 'Active'),
(1024, 102, 45, 12, 20.00, 2.00, 100.00, 3.00, 'test me', 'Active'),
(1025, 102, 45, 16, 25.00, 4.00, 100.00, 5.00, 'test me', 'Active'),
(1026, 102, 45, 17, 20.00, 6.00, 100.00, 7.00, 'test me', 'Active');
...
(6, 'Raj kiran', '1234567890', '123456789', 'rajkiran@gmail.com', 0, 'Male', 'heeloo.png', 'Active'),
...
(0, 'SMTP', 'a:5:{s:10:\"mailsender\";s:38:\"Thakur College of science and Commerce\";s:10:\"smtpserver\";s:21:\"mail.technopulse.cyou\";s:8:\"smtpport\";s:2:\"26\";s:7:\"loginid\";s:23:\"mailer@technopulse.cyou\";s:8:\"password\";s:12:\"QKza_.KeAfwW\";}', 'Active');
...
(45, 2, 2, 'Pter Kindg', 'Male', '7413WIN_20170813_22_04_55_Pro.jpg', '44456789', 'q1w2e3r4', 'mahesh@gmail.com', 'sfsdfsdf', '234234234234', 'Active'),
(46, 2, 2, 'swathi bhat', 'Female', '7340IMG-20180114-WA0087.jpg', '15345', '21364', 'sps078@gmail.com', 'not on earth', '9874563210', 'Active'),
(47, 4, 5, 'swathi shetty', 'Female', '17649IMG-20180114-WA0087.jpg', '12542', 'pariswathianna', 'swatijobless@gmail.com', 'somewhere in mars', '9874561230', 'Active');
...
--
ALTER TABLE `exam`
  MODIFY `examid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=105;

--
-- AUTO_INCREMENT for table `exam_result`
--
ALTER TABLE `exam_result`
  MODIFY `exam_resultid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1027;
