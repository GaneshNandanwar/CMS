	...
	<div class="popular-wthree" id="about">
		<div class="container">
			...
			<div class="col-xs-4 popular-wthree-grid">
				...
				<div class="popular-wthree-text">
					<h5>
						<a href="attendancestudentattendance.php" style="color: black"> Number of Attendance records<br>
					<?php
			...
			<div class="col-xs-4 popular-wthree-grid">
				...
				<div class="popular-wthree-text">
					<h5><a href="courseview.php" style="color: black">Number of  Course records<br>
					<?php
			...
			<div class="col-xs-4 popular-wthree-grid">
				...
				<div class="popular-wthree-text">
					<h5><a href="discussionview.php" style="color: black">Number of  Discussion records<br>
					<?php
			...
			<div class="col-xs-4 popular-wthree-grid">
				...
				<div class="popular-wthree-text">
					<h5>
						<a href="discussionreplyview.php" style="color: black">Number of  Discussion reply records<br>
					<?php
			...
			<div class="col-xs-4 popular-wthree-grid">
				...
				<div class="popular-wthree-text">
					<h5>
					<a href="examview.php" style="color: black">Number of Exam records<br>
					<?php
				...
				<div class="popular-wthree-text">
					<h5>
						<a href="examresultview.php" style="color: black">Number of Exam result records<br>
					<?php
				...
				<div class="popular-wthree-text">
					<h5>
						<a href="viewfaculty.php" style="color: black">Number of Faculty records<br>
					<?php
				...
				<div class="popular-wthree-text">
					<h5>
						<a href="feedbackview.php" style="color: black">Number of Feedback records<br>
					<?php
			...
			<div class="col-xs-4 popular-wthree-grid">
				...
				<div class="popular-wthree-text">
					<h5>
						<a href="notesview.php" style="color: black">Number of Notes records<br>
					<?php
			...
			<div class="col-xs-4 popular-wthree-grid">
				...
				<div class="popular-wthree-text">
					<h5>
						<a href="studentview.php" style="color: black">Number of Student records<br>
					<?php
				...
				<div class="popular-wthree-text">
					<h5>
						<a href="subjectview.php" style="color: black">Number of Subject records<br>
					<?php
				...
				<div class="popular-wthree-text">
					<h5><a href="timetableview.php" style="color: black">Number of Timetable records<br>
					<?php
